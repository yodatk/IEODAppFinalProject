...
import '../../edit_report_screen/edit_report_screen.dart';
...
///
class ArgsForAllRelevantReportStream {
  ///
  /// Name of the plot to get reports from
  ///
  ...
  ArgsForAllRelevantReportStream(this.plotName, this.type);
  ...
  bool operator ==(Object other) {
    ...
    return other is ArgsForAllRelevantReportStream &&
        other.plotName == this.plotName &&
        other.type == this.type;
  }

  @override
  int get hashCode => this.plotName.hashCode + this.type.hashCode;
}

///
/// Provider to the view model of the specific report screen
///
final specificReportScreenViewModel =
    Provider.autoDispose<SpecificReportScreenViewModel>(
        (ref) => SpecificReportScreenViewModel());

///
/// Stream Provider to get all relevant reports
///
final allRelevantReports = StreamProvider.autoDispose
    .family<List<Report>, ArgsForAllRelevantReportStream>((ref, args) {
  return ReportHandler()
      .getAllReportsInProjectByTypeByPlot(args.plotName, args.type);
});

///
/// View Model class for the specific report screen
///
class SpecificReportScreenViewModel {
  ///
  ...
  void navigateAndPushCreateReport(
    ...
    final result = await Navigator.of(context).pushNamed(
            ...
            arguments: this.prepareReport(context, reportType))
  ...
  Future<void> generateAndShareReport(
    ...
    final fileName = "${report.name}"
        ...
        "_${dateToDateTimeString(report.timeModified).replaceAll(":", "").replaceAll(".", "_")}" // date + time w/o '/'
